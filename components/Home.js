    ...
    <div className="row">
      <div className="col-sm-12 col-md-6 col-lg-3 my-3">
        <div className="card p-2">
          <img
            ...
            src="https://a0.muscache.com/im/pictures/a8f6a489-d236-4d2d-a57b-a95d928970af.jpg?im_w=720"
          />
          <div className="card-body d-flex flex-column">
            <h5 className="card-title">
              <a href="">Charming Studio less than 10 Miles to Wells' Beaches!</a>
            </h5>
      ...
      <div className="col-sm-12 col-md-6 col-lg-3 my-3">
        <div className="card p-2">
          <img
            className="card-img-top mx-auto"
            src="https://a0.muscache.com/im/pictures/70d71940-9610-46b8-b028-cc190bbfe6e9.jpg?im_w=720"
          />
          <div className="card-body d-flex flex-column">
            <h5 className="card-title">
